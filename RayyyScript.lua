if game.PlaceId == 2753915549 or game.PlaceId == 4442272183 or game.PlaceId == 7449423635 then
    ...
    --------------------------------------------------------------------
    local RenUi = library:AddWindow("Rayyy Script", Enum.KeyCode.RightControl)
    --------------------------------------------------------------------
    local Main = RenUi:AddTab("Menu Farm") -- "6026568198")
    local Combat = RenUi:AddTab("Player") -- "7251993295")
    local ESP = RenUi:AddTab("ESP") -- "6351993291")
    ...
    --------------------------------------------------------------------
    Main:AddSeperator("Rayyy Script")

    Main:AddToggle("Anti AFK", true, function(vu)
    ...
    Main:AddToggle("Auto Confetti", true, function()
    ...
    _G.PointStats = 1
    Stats:AddSlider("Select Point", 1, 2400, 1, function(value)
        _G.PointStats = value
    end)
